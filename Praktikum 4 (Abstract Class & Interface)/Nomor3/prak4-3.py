...
Meskipun demikian, masih ada beberapa kegunaan Interface. Beberapa dari iterface tersebuu dicakup oleh Abstract Base Classes (ABC) Pythons, diperkenalkan dengan Python 2.6. 
Hali itu berguna, jika ingin membuat base classes yang tidak dapat dibuat instance-nya, tetapi menyediakan interface atau bagian tertentu dari implementasinya.
